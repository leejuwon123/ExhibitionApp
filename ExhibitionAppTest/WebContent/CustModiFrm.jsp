...
<table class="table table-striped table-condensed">
	...
	<tr>
		<th>비밀번호</th>
		<td><input type="password" class="form-control" value="<%=custpwd %>"  name="pwd" disabled/></td> 
	</tr>
	<tr>
		<th>이 름</th>
	...
	<tr>
		<th>휴대폰번호</th>
		<td><input type="text" maxlength="13" name="phone"  class="form-control" placeholder="010-0000-0000 형식으로 입력하세요"/>
		</td>
	</tr>
	<tr>
		<th colspan="2">
