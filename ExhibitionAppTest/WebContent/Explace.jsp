...
<div class="table-responsive table-wrap customer">
	<table class = "table table-hover table-bordered text-center-striped">
		...
		if(rs.next()){
			do{
				...
				String locations = rs.getString("location");//conn에 location중복에 의해 스트링명 다르게 작성
			...
			%>
				<tr>		
					...
					<td><%=holiday %></td>		
					<td>
						<form action="ExplaceModiFrm.jsp">
